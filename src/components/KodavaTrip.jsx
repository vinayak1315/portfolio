...
const Ekin = ({ onPrev, onNext }) => {
  ...
  return (
    <div className="m-auto mb-20 md:mb-[165px] px-4 md:px-0" style={{ fontFamily: 'Poppins, sans-serif', maxWidth: '1100px' }}>
      <motion.div style={{ fontFamily: "'Bestie Seventy', cursive" }} className="text-[28px] md:text-[48px] font-medium flex flex-col items-center" {...fadeUp(0)}>Kodava Drip</motion.div>
      ...
      <motion.div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-3 md:mt-[48px] w-full gap-1 sm:gap-0" {...fadeUp(0.18)}>
        <div className="text-[14px] sm:text-[20px] font-medium">Client: <span className="font-bold ml-[8px]">Kodava Drip</span></div>
      ...
      <motion.div className="relative mt-3 md:mt-[31px]" {...fadeUp(0.28)}>
        <div className="flex flex-col md:flex-row gap-6 md:gap-[40px] w-full">
          ...
          <div className="w-full md:w-[45%]">
            <ImageWithHover src={koda_01} alt="Koda 01" style={{ marginTop: '17px', width: "100%" }} onClick={() => setPopup('image1')} icon="🔍" label="View Image" autoHeight />
            <div className="w-full flex justify-between mt-[34px] gap-[26px]">
              <ImageWithHover src={koda_02} alt="Koda 02" style={{ width: '50%', height: '138px' }} onClick={() => setPopup('image2')} icon="🔍" label="View Image" />
              <ImageWithHover src={koda_03} alt="Koda 03" style={{ width: '50%', height: '138px' }} onClick={() => setPopup('image3')} icon="🔍" label="View Image" />
            </div>
            <ImageWithHover src={koda_04} alt="Koda 04" style={{ marginTop: '17px', width: "100%" }} onClick={() => setPopup('image4')} icon="🔍" label="View Image" autoHeight />
          </div>
        ...
        <div onClick={e => e.stopPropagation()} style={{ position: 'relative', maxWidth: '80vw', maxHeight: '85vh', transform: popup ? 'scale(1)' : 'scale(0.88)', transition: 'transform 0.3s ease' }}>
          ...
          {popup && (
            <div style={{ width: '75vw', height: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src={{ image1: koda_01, image2: koda_02, image3: koda_03, image4: koda_04 }[popup]} alt="Popup" style={{ width: '100%', height: '100%', objectFit: 'contain', display: 'block' }} />
            </div>
          )}
        </div>
      </div>, document.body)}
